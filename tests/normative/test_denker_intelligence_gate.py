...
def test_catalog_has_all_required_phases():
    ...
    required = ["phase_01_click_removal","phase_02_hum_removal","phase_03_denoise",
                "phase_04_eq_correction","phase_12_wow_flutter_fix","phase_19_de_esser",
                "phase_20_reverb_reduction","phase_38_presence_boost"]
    for pid in required:
...
def test_fahrplan_builds_without_crash():
    ...
    fp = build_fahrplan(["phase_01_click_removal","phase_03_denoise"],[(0,120,"verse"),(120,225,"chorus")],
                         goal_priorities={"waerme":0.8,"brillanz":0.6},physical_ceiling_hz=13000)
