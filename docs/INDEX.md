...
**Version:** 9.12.9 | **Phasen:** 64 | **Musical Goals:** 14 | **DefectTypes:** 47 | **Kausal-Ursachen:** 53 | **Tests:** ~13.662
...
- **54 DetectionTypes** — vollständiger Defektkatalog in `core/defect_scanner.py`
- **62 Kausal-Ursachen** — Behandlungs-Taxonomie in `core/causal_defect_reasoner.py` (CAUSES → CAUSE_TO_PHASES)
