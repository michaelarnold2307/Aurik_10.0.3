...
_ERA_MIC_RESPONSE: dict[int, list[tuple[float, float]]] = {
    1900: [
        ...
        (
            600.0,
            -1.0,
        ),  # (1000.0, 0.0), (1500.0, +1.5), (2000.0, +1.0), (3000.0, -2.0),  # (4000.0, -8.0), (6000.0, -18.0), (10000.0, -36.0),
    ],
    1910: [
        (20.0, -20.0),
        (80.0, -10.0),
        ...
        (
            500.0,
            -0.5,
        ),  # (1000.0, 0.0), (1500.0, +1.0), (2500.0, -1.0), (4000.0, -6.0),  # (6000.0, -14.0), (10000.0, -30.0),
    ],
    ...
    1920: [
        ...
        (
            500.0,
            -0.5,
        ),  # (1000.0, 0.0), (2000.0, +0.5), (3000.0, +1.0), (5000.0, -1.0),  # (6000.0, -3.0), (8000.0, -10.0), (12000.0, -24.0),
    ],
    ...
    1930: [
        ...
        (
            300.0,
            0.0,
        ),  # (1000.0, 0.0), (3000.0, -0.3), (5000.0, -0.5), (7000.0, -1.5),  # (8000.0, -3.0), (10000.0, -7.0), (14000.0, -18.0),
    ],
    ...
    1940: [
        ...
        (
            300.0,
            0.0,
        ),  # (1000.0, 0.0), (3000.0, +0.3), (5000.0, +0.8), (7000.0, +0.3),  # (8000.0, -0.5), (10000.0, -2.5), (12000.0, -6.0), (16000.0, -18.0),
    ],
    ...
    1950: [
        ...
        (
            300.0,
            0.0,
        ),  # (1000.0, 0.0), (3000.0, +0.5), (5000.0, +1.5), (7000.0, +2.0),  # (9000.0, +1.5), (11000.0, 0.0), (13000.0, -2.0), (16000.0, -8.0),  # (20000.0, -20.0),
    ],
    ...
    1960: [
        ...
        (
            200.0,
            +0.5,
        ),  # (400.0, 0.0), (1000.0, 0.0), (3000.0, +0.8), (5000.0, +2.5),  # (8000.0, +3.0), (10000.0, +2.5), (12000.0, +1.0), (15000.0, -1.0),  # (18000.0, -6.0), (20000.0, -12.0),
    ],
    ...
    1970: [
        ...
        (
            500.0,
            0.0,
        ),  # (1000.0, 0.0), (3000.0, +0.5), (5000.0, +1.5), (8000.0, +2.0),  # (12000.0, +1.5), (15000.0, +0.5), (18000.0, -1.5), (20000.0, -4.0),
    ],
...
_ERA_CONSOLE_EQ: dict[int, list[tuple[float, float]]] = {
    ...
    1970: [
        ...
        (
            200.0,
            +0.8,
        ),  # (400.0, 0.0), (1000.0, 0.0), (3000.0, +0.5), (6000.0, +0.8),  # (9000.0, +1.5), (12000.0, +2.5), (16000.0, +3.0), (20000.0, +2.5),
    ],
...
_ERA_TAPE_RESPONSE: dict[int, list[tuple[float, float]]] = {
    ...
    1950: [
        ...
        (
            400.0,
            0.0,
        ),  # (1000.0, 0.0), (5000.0, -0.3), (8000.0, -1.0), (10000.0, -2.5),  # (12000.0, -5.0), (14000.0, -10.0), (16000.0, -20.0),
    ],
    ...
    1960: [
        ...
        (
            600.0,
            0.0,
        ),  # (1000.0, 0.0), (4000.0, +0.3), (6000.0, +0.5), (8000.0, +0.5),  # (10000.0, 0.0), (12000.0, -0.8), (14000.0, -2.5), (16000.0, -6.0),  # (18000.0, -14.0),
    ],
    ...
    1970: [
        ...
        (
            400.0,
            +0.2,
        ),  # (1000.0, 0.0), (4000.0, +0.2), (8000.0, +0.5), (12000.0, +0.3),  # (15000.0, 0.0), (18000.0, -1.5), (20000.0, -4.0),
    ],
